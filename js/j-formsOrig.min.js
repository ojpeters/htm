$(document).ready(function(){
	function e(){$("#j-forms .logic-block-checkbox").change(function(){
		...
		}).change()}$("#phone").mask("(999) 999-9999",
		{placeholder:"x"}),$("#pickup_date").datetimepicker({dateFormat:"mm/dd/yy",
		timeFormat:"hh:mm",prevText:'<i class="fa fa-caret-left"></i>',
		nextText:'<i class="fa fa-caret-right"></i>'}),
		$("#return_date").datetimepicker({dateFormat:"mm/dd/yy",timeFormat:"hh:mm",
		...
		$("#j-forms").validate({
			...
			rules:{name:{required:!0},
				...
				messages:{
						...
						airport:{required:"Please enter an airport name"},
				...
				submitHandler:function(){
					$("#j-forms").ajaxSubmit({
						target:"#j-forms #response",error:function(e){
				...
				$("form.j-multistep").length&&$("form.j-multistep").each(function(){
					...
					l.click(function(){
						...
						t=$("#"+s).find("fieldset.active-fieldset").index("fieldset");e>t+1;)$("#"+s+" fieldset").eq(e-1).find('select, textarea, input[type="text"], input[type="email"]').val(""),$("#"+s+" fieldset").eq(e-1).find('input[type="radio"], input[type="checkbox"]').prop("checked",!1),e--
						}),
					a.on("click",function(){
